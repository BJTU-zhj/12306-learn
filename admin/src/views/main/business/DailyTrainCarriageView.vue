<template>
  <p>
    <a-space>
      <train-select-view v-model:value="selectParam.trainCode" placeholder="请选择车次"/>
      <a-date-picker v-model:value="selectParam.date" valueFormat="YYYY-MM-DD" placeholder="请选择日期"/>
  ...
  <a-modal v-model:visible="visible" title="每日车厢" @ok="handleOk"
    ...
    <a-form :model="dailyTrainCarriage" :label-col="{span: 4}" :wrapper-col="{ span: 20 }">
      ...
      <a-form-item label="车次编号">
        <train-select-view v-model:value="dailyTrainCarriage.trainCode" placeholder="请选择车次"/>
      </a-form-item>
